...
import beans from '../_public/beans.png';
import cheese from '../_public/cheese.jpg';
import honey from '../_public/honey.jpg';
import pasta from '../_public/pasta.png';
import wine from '../_public/wine.jpg';
        ...
        <div className="carousel" style={{background: priorityItem.color }}>
            ...
            <div className="carouselInner">
                ...
                {carouselItems.map((item, index) => (
                    <Image key={index} src={item.image} alt={item.alt} className={`item ${index === 2 ? "active" : ""}`}/>
                ))}
